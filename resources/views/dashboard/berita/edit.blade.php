        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    name=judul_berita placeholder="Judul Berita" value="{{ old('judul_berita', $berita->judul_berita) }}">
                    @error('judul_berita')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form_control" id="slug" name="slug" placeholder="Slug Berita"
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control @error ('foto') is-invalid @enderror" id="foto" name="foto">
                    <p style="margin-top: 10px; font-size: 90%; color: rgb(18, 138, 250);">
                        <i> Upload foto jika ada perubahan </i></p>
                    @error('foto')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
